...
GoN2N 是一个面向 Windows 10/11 64 位系统的 n2n 图形化客户端。它通过 n2n `edge`
...
- [二、安装](#二安装)
  ...
  - [2.2 Windows安装 GoN2N](#22-客户端安装-gon2n)
- [三、更新](#三更新)
...
在 Windows 电脑下载 [`GoN2N-v0.1.0-windows-x64.zip`](https://github.com/langstaffe/GoN2N/releases/download/v0.1.0/GoN2N-v0.1.0-windows-x64.zip)，解压后运行：
